$(function () {
    var $w = $(window), $b = $('body'), $promo_slides = $('#promo_slides');
    ...
    $('.icon-down').click(function () {
        ...
        if ($(window).width() > 769)
            offset = 79;
        $('html, body').animate({scrollTop: $(pos).offset().top - offset}, 1000);
    });
    ...
    $(".social").click(function (e) {
        ...
        var width = 550, height = 400, left = ($(window).width() - width) / 2,
            top = ($(window).height() - height) / 2,
            url = this.href, args = 'status=1' + ',width=' + width + ',height=' + height + ',top=' + top + ',left=' + left;
